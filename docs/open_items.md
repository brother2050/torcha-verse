...
总计 24 条, **A 档 4 条 + B3 + D1/D7 全部 ✅ (commit d42a16e, tag v0.4.0)**, **D2/D3/D4/D5/D6/D8 ✅ (本批 commit)**, **B1 部分: 38 → 28 silent degrade 补 warning (本批 10 处)**, **C 档 8 子任务仍未启动 (符合预期)**。
