...
| **C** | v1.0.0 纲要(已锁) | 6/8 (C1/C2/C4/C5/C6/C7 ✅ 骨架 + 6 个 v0.4.3 加深, 余 C3 Gloo 分布式 + C8 真模型 e2e) | 6-12 周 | C3 启动条件: 选 backend 时点; C8 启动条件: HF/Civitai 镜像可访问 + GPU 到位 |
| **D** | 低优 / 长尾 | 8/8 (D1-D8 ✅ 全部完成, D2/D3/D4/D5/D6/D8 本批 + D1/D7 commit `d42a16e`) | 散点 | 顺路处理 |

总计 24 条, **A 档 4 条 + B 档 2 条 (B1 + B3) + D 档 8/8 + C 档 6/8 (C1/C2/C4/C5/C6/C7 骨架 + 6 个 v0.4.3 加深) 全部 ✅** (commits: d42a16e / 66ee457 / 3d231eb / de35b14 / v0.4.3 本批), **B1 38 → 0 silent degrade 全清**, **C 档 C3 Gloo 分布式 + C8 真模型 e2e 仍未启动 (符合预期)**。
...
**v0.4.2 在 commit `de35b14` 落地 C 档 6/8 骨架, v0.4.3 在本批对 6 个骨架做加深**
