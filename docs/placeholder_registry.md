...
>
> 最近一次更新:2026-06-25 · 合计:**63 处**(8 协议/抽象 + 2 TP/PP placeholder + 35 try/except 兜底 + 18 if-branch / mixed-degrade noop)
...
| 63 | `scripts/check_hardcoding_rules.py:137` | D1 阶段三 `Rule.check` abstract method `raise NotImplementedError` | 协议/抽象方法:子类必须实现,4 个内置 Rule 子类均已实现 |
