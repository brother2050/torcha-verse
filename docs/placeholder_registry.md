...
>
> 最近一次更新:2026-06-26 · 合计:**72 处**(10 协议/抽象 + 2 TP/PP placeholder + 37 try/except 兜底 + 23 if-branch / mixed-degrade noop)
...
| 63 | `scripts/check_hardcoding_rules.py:143` | D1 阶段三 `Rule.check` abstract method `raise NotImplementedError` | 协议/抽象方法:子类必须实现,7 个内置 Rule 子类均已实现 |
